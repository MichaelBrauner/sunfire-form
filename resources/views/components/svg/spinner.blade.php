<svg {{$attributes}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" display="block">
    ...
    <g transform="rotate(45 -50.355 121.569)">
        <circle r="6" fill="currentColor" fill-opacity=".875">
    ...
    <g transform="rotate(90 -15 65)">
        <circle r="6" fill="currentColor" fill-opacity=".75">
    ...
    <g transform="rotate(135 -.355 41.569)">
        <circle r="6" fill="currentColor" fill-opacity=".625">
    ...
    <g transform="rotate(180 10 25)">
        <circle r="6" fill="currentColor" fill-opacity=".5">
    ...
    <g transform="rotate(-135 20.355 8.431)">
        <circle r="6" fill="currentColor" fill-opacity=".375">
    ...
    <g transform="rotate(-90 35 -15)">
        <circle r="6" fill="currentColor" fill-opacity=".25">
    ...
    <g transform="rotate(-45 70.355 -71.569)">
        <circle r="6" fill="currentColor" fill-opacity=".125">
